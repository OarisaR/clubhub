  ...
  final List<Map<String, dynamic>> features = [
    {
      'title': 'Explore Clubs',
      'subtitle':
          'Discover a club for every interest, from coding to climbing.',
    ...
    },
    {
      ...
      'subtitle':
          'Never miss out. Get instant notifications for events and meetings.',
    ...
    },
    {
      ...
      'subtitle':
          'Chat with club members and manage your schedule effortlessly.',
          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Color(0xFFD4E7D4), Color(0xFFE8F3E8)],
              ),
            ),
          ),
  ...
  List<Widget> _buildTopWaves(BuildContext context) {
    ...
    return [
      Positioned(
        ...
        child: CustomPaint(
          size: Size(width, 300),
          painter: TopWavePainter(color: AppColors.primary, opacity: 1.0),
        ),
      ),
      Positioned(
        top: -40,
        ...
        child: CustomPaint(
          size: Size(width, 260),
          painter: TopWavePainter(color: AppColors.primary, opacity: 0.7),
        ),
      ),
      Positioned(
        top: -30,
        ...
        child: CustomPaint(
          size: Size(width, 220),
          painter: TopWavePainter(color: const Color(0xFF4a7bb8), opacity: 0.4),
        ),
      ),
      Positioned(
        top: -20,
        ...
        child: CustomPaint(
          size: Size(width, 180),
          painter: TopWavePainter(color: const Color(0xFF6b9bd1), opacity: 0.2),
        ),
      ),
    ];
  }
  ...
  List<Widget> _buildBottomWaves(BuildContext context) {
    ...
    return [
      Positioned(
        ...
        child: CustomPaint(
          size: Size(width, 250),
          painter: BottomWavePainter(color: AppColors.primary, opacity: 1.0),
        ),
      ),
      Positioned(
        bottom: -40,
        ...
        child: CustomPaint(
          size: Size(width, 210),
          painter: BottomWavePainter(color: AppColors.primary, opacity: 0.7),
        ),
      ),
      Positioned(
        bottom: -30,
